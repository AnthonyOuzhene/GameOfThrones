...
class AppController extends BaseController
{
    ...
    public function homepage()
    {
        ...
        return view('main.homepage', ['characters' => $characters]);
    }
    ...
    public function characterPage($id)
    {
        ...
        return view('main.character', compact('character'));
    }
    ...
    {
        $houses = House::all();
        return view('main.houses', compact('houses'));
    ...
    public function house($id)
    {
        ...
        return view('main.house', compact('house','characters'));
